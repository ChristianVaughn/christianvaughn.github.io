    ...
    <section className="section">
      <div className="pb-50">
        ...
        <Row>
          ...
          >
            <p>
              Hello! My name is <strong>Christian Vaughn</strong>. I am a
              multifaceted Software Engineer, skilled in Python, TypeScript, and
              backend development. My professional experience encompasses
              designing, developing, testing, and deploying efficient software
              solutions, with a demonstrated knack for creating effective
              architecture.{" "}
            </p>

            <div className="mt-30 mb-30 mb-md-0">
              <a
                href="mailto:contact@christianvaughn.net?subject=Resume%20Request"
          ...
          >
            <p>
              ...
              technology solutions, always eager to learn and embrace new
